...
The doctor tells me that **genetics** account for around 20% of the diagnoses for type 1, so the rest has to be **environmental**. There must be something in Finland and Sweden that makes people sick. So let's update the tally of **shit hands** I have been dealt with by this country in increasing order of severity:

1. I was [assaulted](/wink)
2. My boots were stolen at the gym in 2017. (No blog post yet. Too soon. 😭)
3. I got [diabetes](/diabetes)

She adds that more analysis is needed. I'm given an insulin stash and glucose measurement tech that I **attach** directly to my skin and sends data to the phone. Then, through the phone, it **forwards** it to the hospital, so that they can track in real time if I'm alive and in case send flowers.
