...
Remember how in the endgame I was all but surrounded and the computer predicted mate in 2? Then I did a **hail mary** check to their king, and **Stockfish** was suddenly 50-50, like, whatever.
...
Ok, the King is forced to H2. Here we are 50-50, but my next move Queen to F1 loses me the game. So let's move something else, like... like maybe **Queen to D6 check**?

![Endgame 2.2](final_5.png)

My queen is still safe by pure miracle. The King is forced back to the **first rank** because it's either that or his wife jumping in front of the bullet, which leads to a defeat for White, so it's a large bucket of nope.
