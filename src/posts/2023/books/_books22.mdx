...
We **need** the challenge of books. Reading is **difficult** because it requires undivided, prolonged attention. It wants us to be able to second guess our certainties, combine ideas, store them in our skull to be accessed when opportunity calls, and use them to change the world.
...
Finally, when things look bleak and you don't seem to progress as much as you would, remember that you don't have to be perfect. It takes time to **git gud**. Try again later, summon helpers, and remember that everyone is as pickled as you are. For instance, this is Elon Musk's build in **Elden Ring**...
