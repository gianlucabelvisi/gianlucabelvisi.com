...
cardImage: "cover_mobile.jpg"
featureImage: "cover_mobile.png"
...
This is a **touchy** subject, hence the **royal we** in the sentence above. Creating some distance with the author, whose views I don't necessarily endorse.
...
In the same vein, this post is not making light of animals' plights. To discern its true target <small>(spoiler it's people)</small>, you will have to reach the **conclusion**, which many of you won't do because, even with these caveats in place, at the only **hint** of a fictional pet being mistreated, you will literally lose your minds.
...
To aid your journey through this post, should you choose to embark, I have strategically placed a few **piece-of-shit** emojis next to the most contentious jokes.
...
As a consequence, **YouTube** now thinks that I'm into the genre and keeps suggesting videos of animals in peril, meaning that I am no longer being fed with tutorials on how to make 48 hours fermented pizza, which is why I keep delivering these ungrateful turds...
...
This solution gets the job done, but does not optimize for time, creating a gaping opportunity cost. And as a side effect you end up **murdering** a bunch of people that probably did not deserve it.
...
![I'm not sure I get it](memento.jpg)
...
<FigureLabel>But dog is looking for a job</FigureLabel>
