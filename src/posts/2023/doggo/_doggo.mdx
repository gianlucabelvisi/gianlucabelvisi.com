...
If you are aghast at the thought of me withholding food from a dog to reduce waste, or turning him into a heroin addict for clicks, how do you justify **neutering** them?
...
But my stance isn't solely based on a moral prescription. It also aligns with my approach to training. Reward is pivotal in teaching a pet new skills, and sometimes a toy or a treat won't cut it, so I go above and beyond my duty and offer the dog experiences that cater to his **natural instincts**.
...
I believe that we have become too spoiled, what with our smartphones, our streaming services, and the possibility of pulling water to make the **human waste** go away to a place nobody knows about.

We are simply not equipped with the skills and temperament to responsibly take care of a **problematic** pet.

These dogs have experienced more **trauma** that you could ever fathom. They have navigated the harsh realities of street life, scavenged for food. They had to turn tricks to survive.

Fortunately, in the land of Sweden, of which I am a **genetic** citizen, the issue of stray dogs is non-existent. Saving a dog is a decision that I do not have to make, so that's nice!
...
<TextBox title={"Ok, fine"}>
    ...
    <BlogImage imageName={"ikea"}/>
    <FigureLabel>It's been difficult to tell Midjourney how to render this absolutely real life scenario. This was the least upsetting result of my prompt: "brutalism, digital photography, Ikea. A device feeds on dogs and produces Ikea bookshelves --ar 4:3"</FigureLabel>
</TextBox>

Now, I know what you are thinking. There might be no strays in Sweden, but you can still adopt them from **abroad**.
...
What happens is that certain organizations pick up strays from the streets of, let's say, Athens, only to place them in **dirty** kennels. You then find yourself on a dog adoption website that:
...
Once enough orders are collected, the dogs are packed into an old **Volkswagen** van and driven across Europe for days to be delivered to their new households.

![Van](van.png)

Can you even begin to imagine the **emotional toll** this takes on the already traumatized dogs? They have just left a terrible place -- a ghetto for all intents and purposes. They are confined to a dark, cramped space, and transported to an unknown destination, with no understanding of what their future holds.
...
<Dialogue>Bro, you can stop shaking. You are safe now. No, please, don't go back under the bed! You are acting like this is a <strong>concentration camp</strong>, but I can assure you it's nothing like that! Now, come on, let's go take a shower!</Dialogue>

So, yeah, consider **not** rescuing a dog.

## Breeders

Instead, you want to source your dogs from breeders, who are a professional figures in the sector you can rely upon. Breeders are **Midjourney** of dogs.

<UnicornButton page={"doggo"} id={"10"} tooltip={"If you are an artist, you might need to hate this"}/>

Which is what I did back in the height of Covid. Yes, this is all circling back to me getting a dog. I hope you didn't forget.

Now, getting a dog from a breeder? Not an easy feat back then! It seems like the **pandemic** has done a number on a lot of swedes, who have been in complete isolation, sitting on their asses, working from home, staring at the wall. So now they all feel like they need a dog. Dickheads.

And apparently breeders cannot increase puppy production by force **impregnating** their bitches because that would be considered air-quotes **unethical**.

<UnicornButton page={"doggo"} id={"11"} tooltip={""}/>

This left me with no choice but trying to beat the competition by any means necessary.

Being **Italian**, I feel like I know what needs to be done. I establish a relationship with all the breeders in the Skåne area that deal in Golden Retrievers, so that when the time comes, and a dog *boi* loves a dog *grrl*, and they doggy-style their passion until a puppy is in the oven, I could get a spot at the high table of potential suitors.

To increase my chances, I know that I have to go the extra mile. I know that I have to lie.

## Lying

Emmanuel Kant was categorically against lying, as we saw [last time](philosophy). Plato had a use for the so-called **noble lies** when they promote some kind of social harmony or benefit. Jesus was like whatever. 🤷🏽

My position on lying will be better discussed in the next post. For noI believe that **lying** is a craft that one must perfect before employing it. You must believe every lie, rehearse any detail and make it yours. There can be no plot holes, no mistakes, as if your life depended on it. Like in that scene in the best Quentin Tarantino film...
...
I sent to all Golden Retriever breeders the following letter:
...
Warm regards,
Mark Brown Junior and his beautiful wife Grumilda
...
* Even if, I would never date a dog trainer because I'm afraid that she would employ the same techniques on me, and I know they would be effective because, as an Italian, I love dog food very much.

* I have never been lost in a forest. I have never been in a forest. I have never been.

* My name is not Mark Sunderland Junior. Or maybe it is. Let's create some distance with the author.

So, after sending this batch of emails, I just sat waiting on my ass for a reply.

After a few weeks of no answers, I felt ready for compromise. I decided that Border Collies are also cool, even if it would mean no longer being the alpha.

So I found a bunch of breeders specialized in Border Collie and sent them the very same email.

## The response

A few days later I receive a phone call from a number not in my contacts. I pick up.

<Dialogue>Mr. Brown?</Dialogue>

I'm about to end the call when I realize that that Mr. Brown is the alias in one of the operations that I'm running.
...
That's when the record scratches and the world freeze frames.
...
<Dialogue>I... we understand. Thank you for realizing this now.</Dialogue>
