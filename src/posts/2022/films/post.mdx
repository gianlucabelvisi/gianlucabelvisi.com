...
Seems like Life is a mess for **chaotic** entities. You might find islands of happiness within the maelstrom, but they are only local minimums that you can easily bounce away from with the right gust of wind, and you will feel the worst person in the world for that.
...
![](pig.jpg)
<FigureLabel>I mean</FigureLabel>
...
Finally, I'm well aware that in the past I have written that top 10 lists are **dumb**, so there is no need to underline the hypocrisy. It was actually kinda rude.
