...
I've been let know that my website is -- and I quote -- esthetically challenging, unpleasant to look at, uncanny valley-y. And don't get me wrong, it's ok for an **amateurish** work, but it's kinda frustrating, because it could have been good with just a little more effort.

Now, in front of this **harsh** but well worded feedback -- so rare these days! -- my only thought was:
...
And I'm not saying this, I'm just **quoting** your dms, or at least the parts that I can read without blushing, you silly pervs. 🙈

Ok, cool. Content. I can subscribe to that! Looking at online venues where content is king 👑, my conclusion is that I need to turn my blog into **Netflix**. Only, you know, with good content!
...
It's not much, but it's honest work. You can see the featured post and then a list of sliders rendering the content collected previously. This concludes the whole Netfl- wait a second I forgot to implement the components! 🙈
...
But how many items should I display on screen? Well, it depends on its **size**. Let's say 5 items for a width of 1200 pixels and above, then progressively fewer, with a minimum of 2 if you are in the bathroom looking at your phone.
