...
This only took me a glass of wine to complete, but that's because when I created my blog I was forward-looking enough to implemented **hashtag** support even if not needed at the time. Amateurish my ass.
