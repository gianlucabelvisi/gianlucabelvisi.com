...
2. Covid has let many people realize that it's not worth working **crappy jobs** for little money, which means that companies now need to pay more to find workers, which inflates prices, which increases inflation
